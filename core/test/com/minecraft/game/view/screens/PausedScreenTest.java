...
public class PausedScreenTest extends LibgdxUnitTest {
    ...
    public void testRender() {
        ...
        verify(font).draw(any(SpriteBatch.class), eq("The game is paused. Press 'P' to resume game."), anyFloat(), anyFloat(), anyFloat(), anyInt(), anyBoolean());
    }
