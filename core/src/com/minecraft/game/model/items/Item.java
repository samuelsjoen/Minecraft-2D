...
public enum Item {
    ...
    DIAMOND_ORE("Diamond ore", "A block of diamond ore", "inventoryItems/diamond_ore.png", 64, null, ItemType.BLOCK, null),
    IRON_ORE("Iron ore", "A block of iron ore", "inventoryItems/iron_ore.png", 64, null, ItemType.BLOCK, null),
    STONE_SNOW("Snow covered stone", "A block of stone covered with snow", "inventoryItems/stone_snow.png", 64, null, ItemType.BLOCK, null),
    DIRT_SNOW("Snow covered dirt", "A block of dirt covered with dirt", "inventoryItems/dirt_snow.png", 64, null, ItemType.BLOCK, null),
    ...
    WOODEN_SWORD("Wooden sword", "A weak sword for fighting", "inventoryItems/wooden_sword.png", 1, new Item[][] {
        {null, WOOD, null},
        {null, WOOD, null},
        {null, STICK, null}
    }, ItemType.SWORD, ItemMaterial.WOOD),
    WOODEN_PICKAXE("Wooden pickaxe", "A weak pickaxe for mining", "inventoryItems/wooden_pickaxe.png", 1, new Item[][] {
        {WOOD, WOOD, WOOD},
        {null, STICK, null},
        {null, STICK, null}
    ...
    IRON_PICKAXE("Iron pickaxe", "A decent pickaxe for mining", "inventoryItems/iron_pickaxe.png", 1, new Item[][] {
        {IRON_ORE, IRON_ORE, IRON_ORE},
        {null, STICK, null},
        {null, STICK, null}
    }, ItemType.PICKAXE, ItemMaterial.IRON),
    DIAMOND_SWORD("Diamond sword", "A powerful sword for fighting", "inventoryItems/diamond_sword.png", 1, new Item[][] {
        {null, DIAMOND_ORE, null},
        {null, DIAMOND_ORE, null},
        {null, STICK, null}
    }, ItemType.SWORD, ItemMaterial.DIAMOND),
    DIAMOND_PICKAXE("Diamond pickaxe", "A powerful pickaxe for mining", "inventoryItems/diamond_pickaxe.png", 1, new Item[][] {
        {DIAMOND_ORE, DIAMOND_ORE, DIAMOND_ORE},
        {null, STICK, null},
        {null, STICK, null}
    }, ItemType.PICKAXE, ItemMaterial.DIAMOND),
    // 2.2 Armor
    IRON_HELMET("Iron helmet", "A decent helmet for protection", "inventoryItems/iron_helmet.png", 1, new Item[][] {
        {IRON_ORE, IRON_ORE, IRON_ORE},
        {IRON_ORE, null, IRON_ORE},
        {null, null, null}
    }, ItemType.HELMET, ItemMaterial.IRON),
    IRON_CHESTPLATE("Iron chestplate", "A decent chestplate for protection", "inventoryItems/iron_chestplate.png", 1, new Item[][] {
        {IRON_ORE, null, IRON_ORE},
        {IRON_ORE, IRON_ORE, IRON_ORE},
        {IRON_ORE, IRON_ORE, IRON_ORE}
    }, ItemType.CHESTPLATE, ItemMaterial.IRON),
    IRON_GLOVES("Iron gloves", "A decent set of gloves for protection", "inventoryItems/iron_gloves.png", 1, new Item[][] {
        {IRON_ORE, null, IRON_ORE},
        {null, null, null},
        {null, null, null}
    }, ItemType.GLOVES, ItemMaterial.IRON),
    IRON_LEGGINGS("Iron leggings", "A decent pair of leggings for protection", "inventoryItems/iron_leggings.png", 1, new Item[][] {
        {IRON_ORE, IRON_ORE, IRON_ORE},
        {IRON_ORE, null, IRON_ORE},
        {IRON_ORE, null, IRON_ORE}
    }, ItemType.LEGGINGS, ItemMaterial.IRON),
    IRON_BOOTS("Iron boots", "A decent pair of boots for protection", "inventoryItems/iron_boots.png", 1, new Item[][] {
        {null, null, null},
        {IRON_ORE, null, IRON_ORE},
        {IRON_ORE, null, IRON_ORE}
    }, ItemType.BOOTS, ItemMaterial.IRON),
    DIAMOND_HELMET("Diamond helmet", "A strong helmet for protection", "inventoryItems/diamond_helmet.png", 1, new Item[][] {
        {DIAMOND_ORE, DIAMOND_ORE, DIAMOND_ORE},
        {DIAMOND_ORE, null, DIAMOND_ORE},
        {null, null, null}
    }, ItemType.HELMET, ItemMaterial.DIAMOND),
    DIAMOND_CHESTPLATE("Diamond chestplate", "A strong chestplate for protection", "inventoryItems/diamond_chestplate.png", 1, new Item[][] {
        {DIAMOND_ORE, null, DIAMOND_ORE},
        {DIAMOND_ORE, DIAMOND_ORE, DIAMOND_ORE},
        {DIAMOND_ORE, DIAMOND_ORE, DIAMOND_ORE}
    }, ItemType.CHESTPLATE, ItemMaterial.DIAMOND),
    DIAMOND_GLOVES("Diamond gloves", "A strong set of gloves for protection", "inventoryItems/diamond_gloves.png", 1, new Item[][] {
        {DIAMOND_ORE, null, DIAMOND_ORE},
        {null, null, null},
        {null, null, null}
    }, ItemType.GLOVES, ItemMaterial.DIAMOND),
    DIAMOND_LEGGINGS("Diamond leggings", "A strong pair of leggings for protection", "inventoryItems/diamond_leggings.png", 1, new Item[][] {
        {DIAMOND_ORE, DIAMOND_ORE, DIAMOND_ORE},
        {DIAMOND_ORE, null, DIAMOND_ORE},
        {DIAMOND_ORE, null, DIAMOND_ORE}
    }, ItemType.LEGGINGS, ItemMaterial.DIAMOND),
    DIAMOND_BOOTS("Diamond boots", "A strong pair of boots for protection", "inventoryItems/diamond_boots.png", 1, new Item[][] {
        {null, null, null},
        {DIAMOND_ORE, null, DIAMOND_ORE},
        {DIAMOND_ORE, null, DIAMOND_ORE}
