...
public class HealthView {
    ...
    public HealthView(Health health){
        ...
        this.splitHealthFrames = TextureRegion.split(healthBarSheet, healthBarSheet.getWidth(), healthBarSheet.getHeight() / 5);
        this.armorHealthSheet = new Texture(Gdx.files.internal("assets/overlay/armorBar.png"));
        this.splitArmorFrames = TextureRegion.split(armorHealthSheet, armorHealthSheet.getWidth(), armorHealthSheet.getHeight() / 5);
        this.health = health;
    }
